            ...
            <div class="card-body">
                <form action="empleados" method="post" onsubmit="return validarFormulario();">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="fechaingreso" id="fechaingreso" value="<%= editando ? empleado.getFechaIngreso().toLocalDateTime().toString().replace(' ', 'T') : "" %>" required>
                    </div>
